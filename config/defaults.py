...
_C.MODEL.WEIGHTS = "./weights.pth"  # should be a path to pth or ckpt file
...
# ---------------------------------------------------------------------------- #
_C.DATALOADER = CN()
_C.DATALOADER.NUM_WORKERS = 6   # Number of data loading threads
...
_C.DRIVE = CN()
_C.DRIVE.IMAGE = CN()
_C.DRIVE.IMAGE.CROP_HEIGHT = [0, 160]
