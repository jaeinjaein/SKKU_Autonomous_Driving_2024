...
{
  new (message_memory) my_custom_msgs::msg::LidarData(_init);
}

void LidarData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_custom_msgs::msg::LidarData *>(message_memory);
  typed_message->~LidarData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember LidarData_message_member_array[2] = {
  {
    "angle",  // name
    ...
    offsetof(my_custom_msgs::msg::LidarData, angle),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_msgs::msg::LidarData, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LidarData_message_members = {
  ...
  2,  // number of fields
  sizeof(my_custom_msgs::msg::LidarData),
...
get_message_type_support_handle<my_custom_msgs::msg::LidarData>()
{
  return &::my_custom_msgs::msg::rosidl_typesupport_introspection_cpp::LidarData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_msgs, msg, LidarData)() {
  return &::my_custom_msgs::msg::rosidl_typesupport_introspection_cpp::LidarData_message_type_support_handle;
}
