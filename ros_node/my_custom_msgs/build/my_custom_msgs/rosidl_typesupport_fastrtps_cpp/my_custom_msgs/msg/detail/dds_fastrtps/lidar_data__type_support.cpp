...
#include "my_custom_msgs/msg/detail/lidar_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_custom_msgs::msg::LidarData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_msgs::msg::LidarData & ros_message)
{
  // Member: angle
  cdr >> ros_message.angle;
...
{
  auto typed_message =
    static_cast<const my_custom_msgs::msg::LidarData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_custom_msgs::msg::LidarData *>(
    untyped_ros_message);
...
{
  return max_serialized_size_LidarData(full_bounded, 0);
}
...
{
  return &my_custom_msgs::msg::typesupport_fastrtps_cpp::_LidarData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_msgs, msg, LidarData)() {
  return &my_custom_msgs::msg::typesupport_fastrtps_cpp::_LidarData__handle;
}
